(function() {
  ...
  const URI = "http://localhost:8080/api/pedidos-fornecedores";

  angular
    .module("app")
    .service("PedidoFornecedorService", PedidoFornecedorService);

  PedidoFornecedorService.$inject = ["$http"];

  function PedidoFornecedorService($http) {
